module ApplicationHelper
  ...
  def title
    config['admin.title'] || 'Dealer Ignition'
  end
  ...
  def class_for_user
    classes = []
    classes << 'user_admin' if current_user and current_user.admin?
    classes << 'user_developer' if current_user and current_user.developer?
    classes << 'user_normal' if classes.empty?
    classes.join(' ')
  end
